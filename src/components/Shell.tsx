...
import { canManageUsers, canEditPartnerRole, canViewFunnels } from "@/lib/admin-users";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        {user.role === "admin" && (
          <div className="mx-auto max-w-7xl px-6">
            <NavTabs
              ...
              canEditPartnerRole={canEditPartnerRole(email)}
              canViewFunnels={canViewFunnels(email)}
            />
          </div>
        )}
      </header>
      ...
      <footer className="border-t border-gray-200 bg-white py-4 text-center text-xs font-semibold text-gray-500">
        Hecho por FE Consulting ✨ para Valor Pyme
      </footer>
    </div>
  );
}
